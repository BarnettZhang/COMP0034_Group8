...
def create_survey():
    ...
    if request.method == 'POST':
        survey = Survey(user_username=name, target_gender=form.target_gender.data, target_maximum_age=form.target_maximum_age.data,
                        ...
                        q2question_num=form.q2question_num.data, q2question_must=form.q2question_must.data,
                        ...
                        q3question_num=form.q3question_num.data, q3question_must=form.q3question_must.data,
                        ...
                        q4question_num=form.q4question_num.data, q4question_must=form.q4question_must.data,
                        ...
                        q5question_num=form.q5question_num.data, q5question_must=form.q5question_must.data,
                        ...
                        q6question_num=form.q6question_num.data, q6question_must=form.q6question_must.data,
                        ...
                        q7question_num=form.q7question_num.data, q7question_must=form.q7question_must.data,
                        ...
                        q8question_num=form.q8question_num.data, q8question_must=form.q8question_must.data,
                        ...
                        q9question_num=form.q9question_num.data, q9question_must=form.q9question_must.data,
                        ...
                        q10question_num=form.q10question_num.data, q10question_must=form.q10question_must.data,
                        ...
                        q11question_num=form.q11question_num.data, q11question_must=form.q11question_must.data,
                        q11question_content=form.q11question_content.data,
                        q12question_num=form.q12question_num.data, q12question_must=form.q12question_must.data,
                        q12question_content=form.q12question_content.data,
                        q13question_num=form.q13question_num.data, q13question_must=form.q13question_must.data,
                        q13question_content=form.q13question_content.data,
                        q14question_num=form.q14question_num.data, q14question_must=form.q14question_must.data,
                        q14question_content=form.q14question_content.data,
                        q15question_num=form.q15question_num.data, q15question_must=form.q15question_must.data,
...
def survey_review_profile():
    if 'username' in request.cookies:
        ...
        # trying2 = Survey.query.filter_by(survey_name="TEST123").first()
        # print('pls work xD : ' + str(trying2.id), file=sys.stderr)
        # result_first = User.query.filter_by(username=name)
        ...
        #         #                        Survey.survey_name.label('survey_name')).all()
        #         # results_only = srp_table.query.filter_by(srp_table.username.contains(name)).all()
        if not results_only:
